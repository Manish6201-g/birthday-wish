...
export async function uploadMediaToCloudinary(fileBuffer, folder = "birthday_uploads", resourceType = "auto") {
...
export async function uploadImageToCloudinary(fileBuffer, folder = "birthday_photos") {
  return uploadMediaToCloudinary(fileBuffer, folder, "image");
}
