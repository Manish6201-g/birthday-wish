...
import { Cake, Sparkles, Plus, Eye, ArrowRight, ShieldCheck, Heart, Zap, Image as ImageIcon } from "lucide-react";

export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-950 via-black to-purple-950 text-white relative overflow-x-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 py-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/create"
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 hover:from-pink-600 hover:via-purple-600 hover:to-indigo-600 text-white px-8 py-4 rounded-full font-bold text-base shadow-2xl transition-all hover:scale-105 border border-white/20"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          ...
          >
            ...
            <p className="text-purple-300/70 text-sm leading-relaxed">
              Upload multiple photo memories with custom captions displayed in an interactive 3D cube Swiper slider.
            </p>
          </motion.div>
